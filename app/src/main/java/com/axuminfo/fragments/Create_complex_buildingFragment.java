...
public class Create_complex_buildingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.create_complex_building, container, false);
    ...
    public boolean submit(View view){
        if(!MainActivity.checkConnection()){
            MainActivity.showAlertDialog(getString(R.string.no_internet), getString(R.string.OK), "");
            return false;
        }
        ...
        String OPERATION_TYPE="create_complex_buildings";
        backgroundWorker.execute(OPERATION_TYPE, name, description);

        /*boolean success=MainActivity.db.insert_complex_buildings(0, name, description, "", "");
